...
class Hero extends StatefulWidget {
  ...
  static Map<Object, _HeroState> _allHeroesFor(
      BuildContext context, bool isUserGestureTransition) {
    assert(context != null);
    ...
    if (manifest.type == HeroFlightDirection.push &&
      ...
      if (manifest.fromHero != newManifest.toHero) {
        ...
        heroRectTween = _doCreateRectTween(heroRectTween.end,
            _globalBoundingBoxFor(newManifest.toHero.context));
      } else {
...
class HeroController extends NavigatorObserver {
  ...
  void _maybeStartHeroTransition(
    ...
    if (toRoute != fromRoute &&
      ...
      if (isUserGestureTransition &&
        ...
        SchedulerBinding.instance.addPostFrameCallback((Duration value) {
          _startHeroTransition(
              from, to, animation, flightType, isUserGestureTransition);
        });
      }
  ...
  void _startHeroTransition(
    ...
    final Map<Object, _HeroState> fromHeroes =
        Hero._allHeroesFor(from.subtreeContext, isUserGestureTransition);
    final Map<Object, _HeroState> toHeroes =
        Hero._allHeroesFor(to.subtreeContext, isUserGestureTransition);
