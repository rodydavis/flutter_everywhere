...
void main() {
  ...
  const PointerUpEvent up1 =
      PointerUpEvent(pointer: 1, position: Offset(11.0, 9.0));

  // Down/up pair 2: normal tap sequence close to pair 1
  const PointerDownEvent down2 =
      PointerDownEvent(pointer: 2, position: Offset(12.0, 12.0));

  const PointerUpEvent up2 =
      PointerUpEvent(pointer: 2, position: Offset(13.0, 11.0));

  // Down/up pair 3: normal tap sequence far away from pair 1
  const PointerDownEvent down3 =
      PointerDownEvent(pointer: 3, position: Offset(130.0, 130.0));

  const PointerUpEvent up3 =
      PointerUpEvent(pointer: 3, position: Offset(131.0, 129.0));

  // Down/move/up sequence 4: intervening motion
  const PointerDownEvent down4 =
      PointerDownEvent(pointer: 4, position: Offset(10.0, 10.0));

  const PointerMoveEvent move4 =
      PointerMoveEvent(pointer: 4, position: Offset(25.0, 25.0));

  const PointerUpEvent up4 =
      PointerUpEvent(pointer: 4, position: Offset(25.0, 25.0));

  // Down/up pair 5: normal tap sequence identical to pair 1 with different pointer
  const PointerDownEvent down5 =
      PointerDownEvent(pointer: 5, position: Offset(10.0, 10.0));

  const PointerUpEvent up5 =
