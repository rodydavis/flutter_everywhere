...
void main() {
  ...
  test('toString control test', () {
    ...
    CurvedAnimation curvedAnimation =
        CurvedAnimation(parent: kAlwaysDismissedAnimation, curve: Curves.ease);
  ...
  test('TrainHoppingAnimation', () {
    ...
    final TrainHoppingAnimation animation =
        TrainHoppingAnimation(currentTrain, nextTrain, onSwitchedTrain: () {
