...
SWIFT_CLASS("_TtC23Flutter_Desktop_Example13ExampleWindow")
@interface ExampleWindow : NSWindow
@property (nonatomic, weak) IBOutlet FLEViewController * _Null_unspecified flutterViewController;
- (void)awakeFromNib;
